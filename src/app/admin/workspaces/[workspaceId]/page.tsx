...
export default function WorkspaceSettingsPage() {
  ...
  async function deleteWorkspace() {
    if (!settings || protectedWorkspace || deleteConfirmation !== settings.name || deleting) return;
    try {
      setDeleting(true);
      setError("");
      await updateDoc(doc(db, "workspaces", workspaceId), {
